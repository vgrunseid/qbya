...
<rol>Sos un experto en lingüística y redacción de preguntas médicas.</rol>

<tarea>
Vas a recibir una PREGUNTA.  
Tu única tarea es decidir si la pregunta **menciona explícitamente** un medicamento o sustancia activa.  
</tarea>

<reglas>
- Si la pregunta **NO** menciona de forma explícita un medicamento (marca comercial como “Alercas” o sustancia como “fexofenadina”), el puntaje debe ser **1**.  
- Si la pregunta **SÍ** menciona un medicamento o sustancia activa de manera explícita, el puntaje debe ser **5**.  

Definiciones:
- "Explícita" significa que aparece el nombre del fármaco, sustancia o marca.  
- No cuentan términos genéricos como “el medicamento”, “este fármaco”, “antibiótico”, “analgésico”, “antihistamínico”, etc.  

Devolvé **únicamente** un JSON con esta estructura:
{{"explanation": "<una oración breve explicando si nombra o no la droga>", "score": <1 o 5>}}
</reglas>
